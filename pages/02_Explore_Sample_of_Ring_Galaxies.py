...
#https://github.com/ringgalaxies/HIRingGalaxies/blob/main/data/NGC1350/NGC1350_1.fits

path_to_check = f'https://raw.githubusercontent.com/ringgalaxies/HIRingGalaxies/main/data/{optionImage}/{optionImage}_NHI.fits'
path = Path(path_to_check)

#if path.is_file():
fits_NHI = f'https://raw.githubusercontent.com/ringgalaxies/HIRingGalaxies/main/data/{optionImage}/{optionImage}_NHI.fits'
#else:
...
def get_survey_image(optionImage, survey_number):
    ...
    # Need to check if file exist
    path_to_check = f'https://raw.githubusercontent.com/ringgalaxies/HIRingGalaxies/main/data/{optionImage}/{optionImage}_{survey_number}.fits'
    path = Path(path_to_check)

    #if path.is_file():
    survey_image = f'https://raw.githubusercontent.com/ringgalaxies/HIRingGalaxies/main/data/{optionImage}/{optionImage}_{survey_number}.fits'
    #else:
    #    st.warning("Sorry, the particular file is missing, please try different.")
    #    st.stop()
